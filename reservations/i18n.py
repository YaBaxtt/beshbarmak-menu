...
TEXT = {
    "ru": {
        ...
        "hero_text": "Всего 3 простых шага: выберите время, место и оставьте телефон. Администратор проверит заявку и подтвердит бронь.",
        ...
        "not_confirmed": "После отправки дождитесь статуса «Подтверждено». Страница обновится автоматически.", "submit": "Отправить заявку",
    ...
    "uz": {
        "page_title": "Stol band qilish", "booking": "Stol band qilish", "hero_title": "Stolingiz sizni kutmoqda", "hero_text": "Atigi 3 ta oddiy qadam: vaqtni, joyni tanlang va telefon raqamingizni qoldiring. Administrator arizani tekshirib, bronni tasdiqlaydi.",
        ...
        "check_data": "Ma’lumotlarni tekshiring", "all_correct": "Hammasi to‘g‘rimi?", "guests": "Mehmonlar", "place": "Joy", "not_confirmed": "Yuborgandan keyin «Tasdiqlandi» holatini kuting. Sahifa o‘zi yangilanadi.", "submit": "Arizani yuborish",
